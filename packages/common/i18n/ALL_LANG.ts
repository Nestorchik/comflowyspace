...
const ALLLang: i18nAllLang = {
  ...
  [KEYS.installFromGitUrl]: {
    ...
    'ru': 'Установить из URK на Github'
  },
  ...
  [KEYS.fundamentalsDesc]: {
    ...
    'ru': 'Мы рекомендуем вам сначала изучить основы Stability Diffusion. Это позволит вам лучше понять принципы создания изображений с использованием искусственного интеллекта, и вы сможете использовать Comflowy более эффективно:'
  },
  [KEYS.textToImage]: {
    'en-US': 'Text To Image',
    'zh-CN': '文本转图像',
  ...
  [KEYS.imageToImageDesc]: {
    ...
    'ru': 'Если вы хотите изучить технологию генерации изображений в изображения, вы можете ознакомиться с следующими разделами:'
  },
  [KEYS.bestPractices]: {
  ...
  [KEYS.bestPracticesDesc]: {
    ...
    'ru': 'Помимо основных примеров, есть также еще примеры, которые вы можете посмотреть и попробовать:'
  },
  [KEYS.stopServer]: {
    'en-US': 'Stop Server',
    'zh-CN': '停止服务器',
  ...
  [KEYS.pipInstall]: {
    'en-US': 'Install using pip',
    'zh-CN': 'Pip 安装',
    'ja': 'Pip インストール',
    'ru': 'Установка с помощью pip'
  },
  [KEYS.installPip]: {
    'en-US': 'Install packages with pip',
    'zh-CN': '安装 Pip 包',
    'ja': 'Pip パッケージをインストール',
